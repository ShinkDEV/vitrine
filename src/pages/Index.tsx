      ...
      <section className="relative overflow-hidden">
        ...
        <div className="block md:hidden relative">
          ...
          <div className="px-4 py-4 text-center -mt-24 relative z-20">
            <span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/25 text-primary-foreground text-sm font-semibold backdrop-blur-xl mb-4">
