    ...
    <footer className="bg-card border-t border-border mt-12 pb-20">
      <div className="container mx-auto px-4 py-10 max-w-4xl">
        <div className="flex flex-col items-center gap-6">
          {/* Logo */}
          <Link to="/">
            <img src={logo} alt="Vitrine Rô Siqueira" className="h-12 object-contain" />
          </Link>

          {/* CTA */}
          <Button variant="gradient" size="lg" asChild>
            <Link to="/cadastro">Faça parte</Link>
          </Button>
          ...
          <div className="flex flex-wrap justify-center gap-4 text-xs text-muted-foreground">
            ...
            <span>·</span>
            <Link to="/isencao-de-responsabilidade" className="hover:text-foreground transition-colors">
